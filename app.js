...
const myObj = {
  ...
  skill: ["HTML", "CSS", "JS"],
  job: function () {
    return `${this.name} is a Web Developer who works with ${this.skill[0]}, ${this.skill[1]}, ${this.skill[2]}}`;
  },
  muslim: true,
  pc: { ram: 16, ssd: "500GB", accesories: ["Mouse", "Keyboard", "Speaker"] },
};
...
const person = `${myObj.name} has a Computer. He is good at ${myObj.skill[1]}. PC [Ram - ${myObj.pc.ram}, SSD - ${myObj.pc.ssd}]`;
...
const twoParam = (num1, num2) => (num1 + num2) / 2;
...
const array = [70, 140, 210, 280, 350];

const useMap = array.map((index) => index / 7);

/* ৫. জাভাস্ক্রিপ্ট এ array এর map, forEach, filter, find কোনটা দিয়ে কি হয়। সেটার একটা সামারি লিখে ফেলো।  */ /* I'll do it */
...
const { ram, accesories } = myObj;

const [number, balance] = array;
...
fetch(url)
  ...
  .then((json) => console.log(json[1].thumbnailUrl));
